...
public class CopyObjectRequest extends WebServiceRequest {
     ...
     *          源Object所在的Bucket的名称。
     */
    private void setSourceBucketName(String sourceBucketName) {
     ...
     *          目标Object所在的Bucket的名称。
     */
    private void setDestinationBucketName(String destinationBucketName) {
     ...
     *          目标Object的Key。
     */
    private void setDestinationKey(String destinationKey) {
