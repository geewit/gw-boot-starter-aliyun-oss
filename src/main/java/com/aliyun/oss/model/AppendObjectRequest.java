...
public class AppendObjectRequest extends PutObjectRequest {
    ...
    private AppendObjectRequest(String bucketName, String key, File file, ObjectMetadata metadata) {
    ...
    private AppendObjectRequest(String bucketName, String key, InputStream input, ObjectMetadata metadata) {
    ...
    private void setInitCRC(Long iniCRC) {
        this.initCRC = iniCRC;
    }
