...
public class LiveChannelTarget {
    private static String LIVE_CHANNEL_DEFAULT_TYPE = "HLS";
    private static int LIVE_CHANNEL_DEFAULT_FRAG_DURATION = 5;
    private static int LIVE_CHANNEL_DEFAULT_FRAG_COUNT = 3;
    private static String LIVE_CHANNEL_DEFAULT_PLAY_LIST_NAME = "playlist.m3u8";
