...
public class PolicyConditions {
    private final static String COND_CONTENT_LENGTH_RANGE = "content-length-range";
    private final static String COND_CACHE_CONTROL = "Cache-Control";
    private final static String COND_CONTENT_TYPE = "Content-Type";
    private final static String COND_CONTENT_DISPOSITION = "Content-Disposition";
    private final static String COND_CONTENT_ENCODING = "Content-Encoding";
    private final static String COND_EXPIRES = "Expires";
    private final static String COND_KEY = "key";
    private final static String COND_SUCCESS_ACTION_REDIRECT = "success_action_redirect";
    private final static String COND_SUCCESS_ACTION_STATUS = "success_action_status";
    private final static String COND_X_OSS_META_PREFIX = "x-oss-meta-";

    private static Map<String, List<MatchMode>> _supportedMatchRules = new HashMap<>();
    private List<ConditionItem> _conds = new ArrayList<>();

    static {
        List<MatchMode> ordinaryMatchModes = new ArrayList<>();
        ordinaryMatchModes.add(MatchMode.Exact);
        ordinaryMatchModes.add(MatchMode.StartWith);
        List<MatchMode> specialMatchModes = new ArrayList<>();
