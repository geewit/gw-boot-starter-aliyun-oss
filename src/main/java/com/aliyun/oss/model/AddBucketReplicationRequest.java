...
public class AddBucketReplicationRequest extends GenericRequest {
    ...
    public enum ReplicationAction {
        ...
        ReplicationAction(String replicationAction){
    ...
    private List<String> objectPrefixList = new ArrayList<>();
    private List<ReplicationAction> replicationActionList = new ArrayList<>();
}
