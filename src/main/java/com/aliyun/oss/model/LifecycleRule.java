...
public class LifecycleRule {
    ...
    private List<StorageTransition> storageTransitions = new ArrayList<>();
    ...
    private LifecycleRule(String id, String prefix, RuleStatus status, int expirationDays,
    ...
    private LifecycleRule(String id, String prefix, RuleStatus status, Date expirationTime,
                          AbortMultipartUpload abortMultipartUpload, List<StorageTransition> storageTransitions) {
        this.id = id;
        this.prefix = prefix;
        this.status = status;
