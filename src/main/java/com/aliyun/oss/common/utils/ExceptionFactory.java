...
public class ExceptionFactory {
    ...
    private static OSSException createInvalidResponseException(String requestId, String message,
    ...
    private static OSSException createOSSException(String requestId, String errorCode, String message,
                                                   String rawResponseError) {
