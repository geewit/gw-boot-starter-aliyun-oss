...
public class DefaultServiceClient extends ServiceClient {
    static HttpRequestFactory httpRequestFactory = new HttpRequestFactory();
    ...
    static ResponseMessage buildResponse(Request request, CloseableHttpResponse httpResponse) throws IOException {
