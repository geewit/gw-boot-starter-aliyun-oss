...
interface OSS {
     ...
     */
    @Deprecated
    boolean doesObjectExist(HeadObjectRequest headObjectRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void putBucketImage(PutBucketImageRequest request)
    		throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteBucketImage(String bucketName)
    		throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteBucketImage(String bucketName, GenericRequest genericRequest)
    		throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteImageStyle(String bucketName, String styleName)
    		throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteImageStyle(String bucketName, String styleName, GenericRequest genericRequest)
    		throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void putImageStyle(PutImageStyleRequest putImageStyleRequest)
    		throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void setBucketProcess(SetBucketProcessRequest setBucketProcessRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteBucketCORSRules(String bucketName)
            throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteBucketCORSRules(GenericRequest genericRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteBucketLogging(GenericRequest genericRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException
     */
    void deleteBucketWebsite(GenericRequest genericRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void deleteBucketLifecycle(GenericRequest genericRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void addBucketReplication(AddBucketReplicationRequest addBucketReplicationRequest)
    		throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void deleteBucketReplication(String bucketName, String replicationRuleID)
            throws OSSException, ClientException;
     ...
     * @param addBucketCnameRequest 请求参数。
     * @throws OSSException OSS Server异常信息。
     * @throws ClientException OSS Client异常信息。
     */
    void addBucketCname(AddBucketCnameRequest addBucketCnameRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void deleteBucketCname(String bucketName, String domain)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void deleteBucketCname(DeleteBucketCnameRequest deleteBucketCnameRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void setBucketStorageCapacity(String bucketName, UserQos userQos) throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    UserQos getBucketStorageCapacity(String bucketName) throws OSSException, ClientException;
     ...
     * 默认一个线程、不开启checkpoint。
     *
     * @param downloadFileRequest 分片下载请求。
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void setLiveChannelStatus(String bucketName, String liveChannel, LiveChannelStatus status)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void setLiveChannelStatus(SetLiveChannelRequest setLiveChannelRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void deleteLiveChannel(String bucketName, String liveChannel)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void deleteLiveChannel(LiveChannelGenericRequest liveChannelGenericRequest)
            throws OSSException, ClientException;
     ...
     * @param bucketName Bucket名称。
     * @param liveChannelName Live Channel名称。
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void generateVodPlaylist(String bucketName, String liveChannelName, String PlaylistName,
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void generateVodPlaylist(GenerateVodPlaylistRequest generateVodPlaylistRequest)
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    String generateRtmpUri(String bucketName, String liveChannelName, String PlaylistName,
     ...
     * @throws ClientException OSS Client异常信息。
     */
    String generateRtmpUri(GenerateRtmpUriRequest generatePushflowUrlRequest) 
            throws OSSException, ClientException;
     ...
     * @throws ClientException OSS Client异常信息。
     */
    void createUdf(CreateUdfRequest createUdfRequest)
            throws OSSException, ClientException;
    ...
    void deleteUdf(UdfGenericRequest genericRequest) 
    		throws OSSException, ClientException;
    
    void uploadUdfImage(UploadUdfImageRequest uploadUdfImageRequest) 
    		throws OSSException, ClientException;
    
    List<UdfImageInfo> getUdfImageInfo(UdfGenericRequest genericRequest) 
    		throws OSSException, ClientException;
    
    void deleteUdfImage(UdfGenericRequest genericRequest) 
    		throws OSSException, ClientException;
    
    void createUdfApplication(CreateUdfApplicationRequest createUdfApplicationRequest) 
            throws OSSException, ClientException;
    ...
    void deleteUdfApplication(UdfGenericRequest genericRequest) 
            throws OSSException, ClientException;
 
    void upgradeUdfApplication(UpgradeUdfApplicationRequest upgradeUdfApplicationRequest) 
            throws OSSException, ClientException;
    
    void resizeUdfApplication(ResizeUdfApplicationRequest resizeUdfApplicationRequest) 
            throws OSSException, ClientException;
