...
public class OSSObjectOperation extends OSSOperation {
    ...
    public ObjectMetadata getObjectMetadata(GenericRequest genericRequest)
        ...
        return doOperation(request, getObjectMetadataResponseParser, 
                bucketName, key, true, reponseHandlers);
    }
    ...
    public OSSSymlink getSymlink(GenericRequest genericRequest)
        ...
        if (symbolicLink != null) {
            symbolicLink.setSymlink(symlink);
        }
    ...
    public boolean doesObjectExistWithRedirect(String bucketName, String key) 
        ...
        try {
            ...
            if (Objects.equals(e.getErrorCode(), OSSErrorCode.NO_SUCH_BUCKET)
                    || Objects.equals(e.getErrorCode(), OSSErrorCode.NO_SUCH_KEY)) {
                return false;
            }
            throw e;
        } finally {
    ...
    private <RequestType extends PutObjectRequest, ResponseType> 
        ...
        try {
            ...
            if (originalRequest.getCallback() == null) {
                ...
                result = doOperation(httpRequest, responseParser, bucketName, key, true, reponseHandlers);
            }
