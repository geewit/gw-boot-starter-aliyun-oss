...
final class ResponseParsers {
    ...
    static final GetBucketTaggingResponseParser getBucketTaggingResponseParser = new GetBucketTaggingResponseParser();
    ...
    static final GetUdfInfoResponseParser getUdfInfoResponseParser = new GetUdfInfoResponseParser();
    static final ListUdfResponseParser listUdfResponseParser = new ListUdfResponseParser();
    static final GetUdfImageInfoResponseParser getUdfImageInfoResponseParser = new GetUdfImageInfoResponseParser();
    static final GetUdfApplicationInfoResponseParser getUdfApplicationInfoResponseParser = new GetUdfApplicationInfoResponseParser();
    static final ListUdfApplicationInfoResponseParser listUdfApplicationInfoResponseParser = new ListUdfApplicationInfoResponseParser();
    ...
    public static final class GetUdfApplicationLogResponseParser implements ResponseParser<UdfApplicationLog> {
        ...
        GetUdfApplicationLogResponseParser(String udfName) {
            super();
    ...
    static <ResultType extends GenericResult> void setCRC(ResultType result,
    ...
    static <ResultType extends GenericResult> void setServerCRC(ResultType result,
                                                                ResponseMessage response) {
        String strSrvCrc = response.getHeaders().get(OSSHeaders.OSS_HASH_CRC64_ECMA);
        if (strSrvCrc != null) {
            BigInteger bi = new BigInteger(strSrvCrc);
            ...
            for (String key : headers.keySet()) {
                switch (key) {
                    ...
                    case OSSHeaders.ETAG:
                        ...
                        break;
                    case OSSHeaders.OSS_HEADER_REQUEST_ID:
     ...
     */
    static UdfInfo parseGetUdfInfo(InputStream responseBody)
            throws ResponseParseException {
        try {
            Element root = getXmlRootElement(responseBody);
     ...
     */
    @SuppressWarnings("unchecked")
    static List<UdfInfo> parseListUdf(InputStream responseBody)
            throws ResponseParseException {
     ...
     */
    @SuppressWarnings("unchecked")
    static List<UdfImageInfo> parseGetUdfImageInfo(InputStream responseBody)
            throws ResponseParseException {

        try {
            Element root = getXmlRootElement(responseBody);
            List<UdfImageInfo> udfImages = new ArrayList<>();
     ...
     */
    static UdfApplicationInfo parseGetUdfApplicationInfo(InputStream responseBody)
            throws ResponseParseException {
     ...
     */
    @SuppressWarnings("unchecked")
    static List<UdfApplicationInfo> parseListUdfApplicationInfo(InputStream responseBody)
            throws ResponseParseException {

        try {
            Element root = getXmlRootElement(responseBody);
            List<UdfApplicationInfo> udfApps = new ArrayList<>();
     ...
     */
    @SuppressWarnings("unchecked")
    static List<CORSRule> parseListBucketCORS(InputStream responseBody)
            throws ResponseParseException {
    ...
    static List<ReplicationRule> parseGetBucketReplication(InputStream responseBody)
        ...
        try {
            List<ReplicationRule> repRules = new ArrayList<>();
            ...
            for (Element ruleElem : ruleElems) {
                ...
                if (ruleElem.getChild("PrefixSet") != null) {
                    List<String> objectPrefixes = new ArrayList<>();
                ...
                if (ruleElem.getChild("Action") != null) {
                    ...
                    List<ReplicationAction> repActions = new ArrayList<>();
    ...
    static CreateLiveChannelResult parseCreateLiveChannel(InputStream responseBody)
        ...
        try {
            ...
            List<String> publishUrls = new ArrayList<>();
    ...
    static List<LiveRecord> parseGetLiveChannelHistory(InputStream responseBody)
        ...
        try {
            ...
            List<LiveRecord> liveRecords = new ArrayList<>();
    ...
    static List<LifecycleRule> parseGetBucketLifecycle(InputStream responseBody)
        ...
        try {
            ...
            for (Element ruleElem : ruleElements) {
                ...
                List<StorageTransition> storageTransitions = new ArrayList<>();
    ...
    static List<CnameConfiguration> parseGetBucketCname(InputStream responseBody)
        ...
        try {
            ...
            List<CnameConfiguration> cnames = new ArrayList<>();
