...
public class SignUtils {
    ...
    private static final List<String> SIGNED_PARAMTERS = Arrays.asList(SUBRESOURCE_ACL, SUBRESOURCE_UPLOADS, SUBRESOURCE_LOCATION,
    ...
    static String buildRtmpCanonicalString(String canonicalizedResource, RequestMessage request, String expires) {

        StringBuilder canonicalString = new StringBuilder();

        // Append expires
        canonicalString.append(expires).append(NEW_LINE);
