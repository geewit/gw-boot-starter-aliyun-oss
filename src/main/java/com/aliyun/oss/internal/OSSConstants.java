...
public final class OSSConstants {
    ...
    static final long DEFAULT_FILE_SIZE_LIMIT = 5 * 1024 * 1024 * 1024L;
    ...
    static final String OSS_AUTHORIZATION_PREFIX = "OSS ";
    static final String OSS_AUTHORIZATION_SEPERATOR = ":";
